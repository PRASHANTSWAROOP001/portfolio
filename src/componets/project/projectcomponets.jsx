...
function Projectcomponets({data}) {
  const{level,project,discPara,techPara,codeLink,liveLink } = data
  return (
   <div className=' w-72  h-80 border-2 border-yellow-400 rounded-lg relative'>
...
<div className='flex justify-between '>
    ...
    <div className='mx-2 my-1'> 
      <h1 className='text-xl font-bold text-center  text-transparent bg-clip-text bg-gradient-to-r  from-yellow-400 to-orange-600'> {project} </h1>
    </div>

    <div className=' ml-2 mr-1'>
      <h1 className='text-xl font-bold dark:text-orange-400' >Description</h1>
      <p  className='font-medium dark:text-white'> {discPara} </p>
    </div>

    <div className='mx-2 my-1'>
      <h1 className='text-xl font-bold dark:text-orange-400' >Tech Stack</h1>
      <p className='font-medium dark:text-white'>{techPara}</p>
    </div>
